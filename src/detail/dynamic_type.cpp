  ...
  rosidl_dynamic_typesupport_serialization_support_impl_t * serialization_support_impl, const rosidl_runtime_c__type_description__TypeDescription * description)
{
  ...
  auto type_builder_impl = new rosidl_dynamic_typesupport_dynamic_type_builder_impl_t{std::move(
    static_cast<DynamicTypeBuilder *>(
      fastrtps__dynamic_type_builder_init(serialization_support_impl, main_description->type_name.data, main_description->type_name.size)->handle
    )
  )};
  ...
  for (size_t i = 0; i < main_description->fields.size; i++) {
    ...
    switch (field->type.type_id) {
      ...
      case ROSIDL_DYNAMIC_TYPESUPPORT_FIELD_TYPE_BOOLEAN:
        fastrtps__dynamic_type_builder_add_bool_member(serialization_support_impl, type_builder_impl, i, field->name.data, field->name.size);
        break;
      case ROSIDL_DYNAMIC_TYPESUPPORT_FIELD_TYPE_BYTE:
        fastrtps__dynamic_type_builder_add_byte_member(serialization_support_impl, type_builder_impl, i, field->name.data, field->name.size);
        break;
      case ROSIDL_DYNAMIC_TYPESUPPORT_FIELD_TYPE_CHAR:
        fastrtps__dynamic_type_builder_add_char_member(serialization_support_impl, type_builder_impl, i, field->name.data, field->name.size);
        break;
      case ROSIDL_DYNAMIC_TYPESUPPORT_FIELD_TYPE_FLOAT32:
        fastrtps__dynamic_type_builder_add_float32_member(serialization_support_impl, type_builder_impl, i, field->name.data, field->name.size);
        break;
      case ROSIDL_DYNAMIC_TYPESUPPORT_FIELD_TYPE_FLOAT64:
        fastrtps__dynamic_type_builder_add_float64_member(serialization_support_impl, type_builder_impl, i, field->name.data, field->name.size);
        break;
      case ROSIDL_DYNAMIC_TYPESUPPORT_FIELD_TYPE_INT8:
        fastrtps__dynamic_type_builder_add_int8_member(serialization_support_impl, type_builder_impl, i, field->name.data, field->name.size);
        break;
      case ROSIDL_DYNAMIC_TYPESUPPORT_FIELD_TYPE_UINT8:
        fastrtps__dynamic_type_builder_add_uint8_member(serialization_support_impl, type_builder_impl, i, field->name.data, field->name.size);
        break;
      case ROSIDL_DYNAMIC_TYPESUPPORT_FIELD_TYPE_INT16:
        fastrtps__dynamic_type_builder_add_int16_member(serialization_support_impl, type_builder_impl, i, field->name.data, field->name.size);
        break;
      case ROSIDL_DYNAMIC_TYPESUPPORT_FIELD_TYPE_UINT16:
        fastrtps__dynamic_type_builder_add_uint16_member(serialization_support_impl, type_builder_impl, i, field->name.data, field->name.size);
        break;
      case ROSIDL_DYNAMIC_TYPESUPPORT_FIELD_TYPE_INT32:
        fastrtps__dynamic_type_builder_add_int32_member(serialization_support_impl, type_builder_impl, i, field->name.data, field->name.size);
        break;
      case ROSIDL_DYNAMIC_TYPESUPPORT_FIELD_TYPE_UINT32:
        fastrtps__dynamic_type_builder_add_uint32_member(serialization_support_impl, type_builder_impl, i, field->name.data, field->name.size);
        break;
      case ROSIDL_DYNAMIC_TYPESUPPORT_FIELD_TYPE_INT64:
        fastrtps__dynamic_type_builder_add_int64_member(serialization_support_impl, type_builder_impl, i, field->name.data, field->name.size);
        break;
      case ROSIDL_DYNAMIC_TYPESUPPORT_FIELD_TYPE_UINT64:
        fastrtps__dynamic_type_builder_add_uint64_member(serialization_support_impl, type_builder_impl, i, field->name.data, field->name.size);
        break;
      case ROSIDL_DYNAMIC_TYPESUPPORT_FIELD_TYPE_STRING:
        fastrtps__dynamic_type_builder_add_string_member(serialization_support_impl, type_builder_impl, i, field->name.data, field->name.size);
        break;
      case ROSIDL_DYNAMIC_TYPESUPPORT_FIELD_TYPE_WSTRING:
        fastrtps__dynamic_type_builder_add_wstring_member(serialization_support_impl, type_builder_impl, i, field->name.data, field->name.size);
        break;
      case ROSIDL_DYNAMIC_TYPESUPPORT_FIELD_TYPE_BOUNDED_STRING:
        fastrtps__dynamic_type_builder_add_bounded_string_member(
          serialization_support_impl, type_builder_impl, i, field->name.data, field->name.size,
          field->type.capacity);
        break;
      ...
      case ROSIDL_DYNAMIC_TYPESUPPORT_FIELD_TYPE_BOOLEAN_ARRAY:
        fastrtps__dynamic_type_builder_add_bool_array_member(
          serialization_support_impl, type_builder_impl, i, field->name.data, field->name.size, field->type.capacity);
        break;
      ...
      case ROSIDL_DYNAMIC_TYPESUPPORT_FIELD_TYPE_BOUNDED_STRING_UNBOUNDED_SEQUENCE:
        fastrtps__dynamic_type_builder_add_bounded_string_unbounded_sequence_member(
          serialization_support_impl, type_builder_impl, i, field->name.data, field->name.size, field->type.string_capacity);
        break;
          ...
          switch (field->type.type_id) {
            case ROSIDL_DYNAMIC_TYPESUPPORT_FIELD_TYPE_NESTED_TYPE:
              fastrtps__dynamic_type_builder_add_complex_member(
                serialization_support_impl, type_builder_impl, i, field->name.data, field->name.size, nested_struct);
              break;

            case ROSIDL_DYNAMIC_TYPESUPPORT_FIELD_TYPE_NESTED_TYPE_ARRAY:
              fastrtps__dynamic_type_builder_add_complex_array_member(
                serialization_support_impl,
                type_builder_impl, i, field->name.data, field->name.size, nested_struct, field->type.capacity);
              break;
      ...
      default:
        printf("[ERROR] Invalid field type_impl: %d !", field->type.type_id);
        break;
    }
  }
